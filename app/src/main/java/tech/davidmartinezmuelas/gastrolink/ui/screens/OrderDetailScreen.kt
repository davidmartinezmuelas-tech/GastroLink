...
fun OrderDetailScreen(
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text(text = "Detalle de pedido") },
                navigationIcon = {
        ...
        if (detail == null) {
            Column(
                ...
                Text(text = "No hay detalle disponible")
            }
            return@Scaffold
        }
        ...
        LazyColumn(
            ...
            item {
                ...
                Text(text = "kcal: ${detail.totals.kcal}")
                Text(text = "protein: ${detail.totals.proteinG} g")
                Text(text = "carbs: ${detail.totals.carbsG} g")
                Text(text = "fat: ${detail.totals.fatG} g")
            }
